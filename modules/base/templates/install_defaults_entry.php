    ...
    <form method="POST">
        ...
        <p class="form-row">
            ...
            <span class="form-field">
                ...
                <?php $defaults['domain'] = isset($defaults['domain']) ? $defaults['domain'] : '';
                $defaults['user_id'] = isset($defaults['user_id']) ? $defaults['user_id'] : '';
                $defaults['email_address'] = isset($defaults['email_address']) ? $defaults['email_address'] : '';
                ?>
